...
export function LiquidBackground({ className = "" }) {
    return (
        <div className={cn("fixed inset-0 w-full h-full overflow-hidden pointer-events-none -z-50 bg-zinc-50 dark:bg-zinc-950", className)}>
            ...
            <div className="absolute top-0 right-[-10%] w-[500px] h-[500px] bg-blue-400/30 dark:bg-blue-900/40 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-[80px] opacity-70 animate-blob animation-delay-2000"></div>
            <div className="absolute bottom-[-20%] left-[20%] w-[500px] h-[500px] bg-pink-400/30 dark:bg-pink-900/40 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-[80px] opacity-70 animate-blob animation-delay-4000"></div>
